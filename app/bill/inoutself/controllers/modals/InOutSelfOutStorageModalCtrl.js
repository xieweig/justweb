...
angular.module('app').controller('InOutSelfOutStorageModalCtrl', function ($scope, $timeout, $uibModal, ApiService, Common, data) {
    ...
    if ($scope.modalType !== 'audit') {
        getURL = '/api/bill/inOutSelf/findOutStorageByBillCode'
    } else {
        getURL = '/api/bill/inOutSelf/open'
    }
    ...
    function saveOrAudit(type, bill) {
        var url = '';
        if (type === 'save') {
            url = '/api/bill/inOutSelf/save'
        } else {
            url = '/api/bill/inOutSelf/submit'
        }
    ...
    $scope.audit = function (type) {
        var url = '';
        if (type === 'success') {
            url = '/api/bill/inOutSelf/auditSuccess'
        } else {
            url = '/api/bill/inOutSelf/auditFailure'
        }
        var bill = {
